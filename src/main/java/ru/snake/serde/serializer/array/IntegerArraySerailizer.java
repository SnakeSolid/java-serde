...
public class IntegerArraySerailizer extends Serialiser<int[]> {
	...
	@Override
	public void serialize(final SerializeContext context, final DataOutput stream, final int[] object)
			throws IOException {
	...
	@Override
	public int[] deserialize(final DeserializeContext context, final DataInput stream) throws IOException {
